...
const Footer_ = () => {
  return (
    <footer className="border-t border-slate-800 py-12">
      <div className="flex max-md:flex-col items-start justify-start gap-8 mx-auto md:px-12 sm:px-6 px-2">
        <Link
          to="/"
      ...
      <div className="mt-8 border-t border-slate-800 pt-8 text-center">
        <p className="text-sm text-slate-400">
          &copy; {new Date().getFullYear()} GitMonitor. All rights reserved.
        </p>
      </div>
    </footer>
  );
